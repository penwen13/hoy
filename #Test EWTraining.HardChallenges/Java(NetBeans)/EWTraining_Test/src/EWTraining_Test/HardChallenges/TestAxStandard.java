/*TASK RP.AxStandard Same that AxNoStandard, Standarized*/
...
import java.time.*;
import TowaStandard.*;
import EWTraining.HardChallenges.AxStandard.*;

//======================================================================================================================
public /*static*/ final class TestAxStandard {

    //##################################################################################################################
    private TestAxStandard() {
        /*TO AVOID OBJECT CONSTRUCTION*/
    }
    //##################################################################################################################
    //------------------------------------------------------------------------------------------------------------------
    private static final String strPRJ_SEGMENT = "EWTraining.HardChallenges";
    private static final String strRELEVANT_PART = "AxStandard";
    ...
    public static void subTest() {
        ...
        TestAxStandard.t0anowTEST = null;
        TestAxStandard.t0maskTEST = null;
        /**/
        //
        /*All Test (for specific test, copy above and open)*/
        TestAxStandard.subTestAxStandard1();
        /**/
    }

    //------------------------------------------------------------------------------------------------------------------
    private static void subTestAxStandard1() {
        final String strTEST = "AxStandard1";
        ...
        /*1*/
        {
            ...
            Queue<BeBoatEvent> queuebeTest = TestAxStandard.queuebeTest6Events();
            ...
            Test.log("");
            Tools.subTodayOperation(queuebeTest, dateTest, TestAxStandard.syspathLOGS);
        }
        /**/
        //
        /*2*/
        {
            ...
            Queue<BeBoatEvent> queuebeTest = TestAxStandard.queuebeTest8Events();
